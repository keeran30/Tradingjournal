          ...
          <div className="bg-zinc-900 p-6 rounded-2xl border border-zinc-800">
            ...
            {sent ? <div className="bg-green-900/30 border border-green-500/30 p-4 rounded-xl text-green-400">Message sent! We'll reply within 24 hours.</div> : (
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div><label className="block text-zinc-400 text-sm mb-1">Message</label><textarea value={message} onChange={(e) => setMessage(e.target.value)} placeholder="Tell us what's on your mind..." rows={4} className="w-full p-3 bg-zinc-800 rounded-xl border border-zinc-700 focus:border-yellow-500 outline-none resize-none" required /></div>
