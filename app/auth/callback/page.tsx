        ...
        <div className="bg-zinc-900 p-8 rounded-2xl border border-zinc-800">
          ...
          <form onSubmit={handleAuth} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full p-3 bg-zinc-800 rounded-xl border border-zinc-700 focus:border-yellow-500 outline-none"
                required
              />
            </div>
          ...
          <div className="mt-4">
            ...
            <button
              ...
              className="w-full bg-white hover:bg-gray-100 text-black py-3 rounded-xl font-bold transition flex items-center justify-center gap-2"
            >
